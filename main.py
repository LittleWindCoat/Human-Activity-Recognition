...
def data_loader():
    ...
    test_x = test_x.fillna(axis=1, method='ffill')  # fill in missing values
...
def my_confusion_matrix(y_true, y_pred):
    ...
    print("confusion Matrix：(left labels: y_true, up labels: y_pred):")
    print("labels\t", labels)
    print(conf_mat)
...
def build_two():
    # Choose Random Forest for object 2
    x_train, x_test, y_train, y_test = data_loader()
